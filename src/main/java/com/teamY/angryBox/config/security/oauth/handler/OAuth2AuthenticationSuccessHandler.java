...
import static com.teamY.angryBox.config.security.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        response.addHeader("Auth", "asdfasdfasdf");
        response.addHeader("Refresh", "asdfasdfasdfasdfads");
        response.setContentType("application/json;charset=UTF-8");

//        var writer = response.getWriter();
//        writer.println("asdfasdfasdf");
//        writer.flush();

        log.info(request.getRequestURI());
        super.onAuthenticationSuccess(request, response, authentication);
//        request.setAttribute("dayea", "dayea");
//        response.addHeader(HeaderUtil.HEADER_AUTHORIZATION, "dayea");
